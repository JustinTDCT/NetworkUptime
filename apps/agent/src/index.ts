...
import { runHttpContentCheck, runSslCheck, runUpDownCheck } from "./checks.js";
      ...
      for (const monitor of monitors) {
        const result =
          monitor.type === "ssl"
            ...
            : monitor.type === "http_https"
              ? await runHttpContentCheck(monitor)
              : await runUpDownCheck(monitor);
